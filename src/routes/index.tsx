    ...
    <div className="site-shell">
      ...
      <header className="navbar">
        ...
        <nav className={`nav-links ${menuOpen ? 'is-open' : ''}`} aria-label="Primary navigation">
          ...
          <ButtonLink href={calendlyUrl} className="mobile-booking">Book a Free Consult</ButtonLink>
        </nav>

        <ButtonLink href={calendlyUrl} className="desktop-booking">Book a Free Consult</ButtonLink>
        <button
      ...
      <main id="main-content">
        <section className="hero" id="home">
          ...
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <ButtonLink href={calendlyUrl}>Book a Free Consult</ButtonLink>
              <ButtonLink href="#portfolio" variant="secondary">See My Work</ButtonLink>
            </div>
          </div>

          <div className="hero-reel" aria-label="Demo reel placeholder">
            <video autoPlay muted loop playsInline preload="metadata" poster="/demo-reel-poster.svg">
              <source src="/demo-reel.mp4" type="video/mp4" />
            </video>
            <div className="reel-vignette" aria-hidden="true" />
            <div className="reel-topline">
              <span>Mary Jo Suficiencia</span>
              <span>AI Motion · 2026</span>
            </div>
            <div className="reel-center">
              <button type="button" className="play-button" aria-label="Demo reel video placeholder">
                <Play aria-hidden="true" fill="currentColor" size={22} />
              </button>
              <span>Demo Reel</span>
            </div>
            <div className="reel-footer">
              <span>Replace with /public/demo-reel.mp4</span>
              <span className="reel-line"><i /></span>
              <span>01:24</span>
            </div>
          </div>
        ...
        <section className="about section" id="about">
          <div className="about-portrait reveal">
            <div className="portrait-placeholder">
              <span className="portrait-initials">MJ</span>
              <span className="portrait-label"><Sparkles size={14} aria-hidden="true" /> Your photo here</span>
            </div>
        ...
        <section className="testimonials section">
          ...
          <div className="testimonial-grid">
            {[
              'Your videos look realistic enough to be used for affiliate marketing.',
              'Your editing is good, and the clips are well put together.',
            ].map((quote, index) => (
              <figure className="testimonial-card reveal" key={quote}>
                <div className="quote-mark">“</div>
                <blockquote>{quote}</blockquote>
                <figcaption><span className="avatar-placeholder">0{index + 1}</span><div>Client feedback <small>Placeholder testimonial</small></div></figcaption>
              </figure>
            ))}
          </div>
        </section>
        ...
        <section className="contact section" id="contact">
          ...
          <div className="contact-copy reveal">
            ...
            <ButtonLink href={calendlyUrl}>Book a Free Consultation</ButtonLink>
